...
use hoshiguma_api::{CobsFramer, ExpectedResponse, Message, MessagePayload};
use serde::{Serialize, de::DeserializeOwned};

pub async fn send_request<
    Request: ExpectedResponse<Response = Response> + MessagePayload + Serialize,
