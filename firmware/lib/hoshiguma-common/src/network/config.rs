pub const TELEMETRY_BRIDGE_MAC_ADDRESS: [u8; 6] = [0xF2, 0xFA, 0xEC, 0x8D, 0x87, 0x01];
pub const TELEMETRY_BRIDGE_MAC_ADDRESS_PUBLIC: [u8; 6] = [0xF2, 0xFA, 0xEC, 0x8D, 0x88, 0x01];
