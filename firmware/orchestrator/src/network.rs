...
use heapless::Vec;
use hoshiguma_api::ORCHESTRATOR_IP_ADDRESS;
use hoshiguma_common::network::ORCHESTRATOR_MAC_ADDRESS;
...
pub(super) async fn init(spawner: Spawner, r: EthernetResources) -> Stack<'static> {
    ...
    let (stack, runner) = embassy_net::new(
        ...
        embassy_net::Config::ipv4_static(StaticConfigV4 {
            address: Ipv4Cidr::new(ORCHESTRATOR_IP_ADDRESS, 24),
            gateway: None,
            dns_servers: Vec::new(),
        }),
...
async fn ethernet_task(
    ...
    #[cfg(feature = "trace")]
    crate::trace::name_task("ethernet driver").await;
...
async fn net_task(mut runner: embassy_net::Runner<'static, Device<'static>>) -> ! {
    #[cfg(feature = "trace")]
    crate::trace::name_task("network stack").await;
